...
const faqs = [
  ...
  { q: "What certifications do your fabrics carry?", a: "We maintain ISO 9001:2015 certification and rigorous in-house fabric testing. We do not currently hold GOTS, OEKO-TEX, or GRS certification, but can advise on sourcing certified organic materials on request." },
  { q: "What are your lead times for production orders?", a: "Standard lead times are 6–8 weeks from order confirmation. Rush orders can be accommodated within 4 weeks for stock fabrics." },
  ...
  { q: "What Incoterms do you support?", a: "We offer FOB, CIF, and DDP terms. Reach our export sales team in Mumbai, India to discuss the best delivery option for your market — including DDP delivery to your warehouse via our logistics partners." },
