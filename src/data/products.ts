...
export const products: Product[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    description: "A refined pintuck blouse crafted from 100% organic cotton. Features delicate front pintucks, mother-of-pearl buttons, and a relaxed European fit. Pre-washed for a soft hand-feel.",
    shortDescription: "Organic cotton blouse with pintuck detailing and MOP buttons.",
    ...
    certifications: [], moq: "500 pcs", leadTime: "6–8 weeks", sizeChart: standardSizeChart, exportCompliance,
  ...
  },
  {
    ...
    certifications: [], moq: "300 pcs", leadTime: "6–8 weeks", sizeChart: standardSizeChart, exportCompliance,
  ...
  },
  {
    ...
    certifications: [], moq: "500 pcs", leadTime: "8–10 weeks", sizeChart: standardSizeChart, exportCompliance,
  ...
  },
  {
    ...
    certifications: [], moq: "300 pcs", leadTime: "8–10 weeks", sizeChart: standardSizeChart, exportCompliance,
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    description: "Classic A-line silhouette in organic cotton. Knee-length with side seam pockets and back zip. 24 colourways.",
    shortDescription: "Classic A-line in organic cotton with side pockets.",
  ...
  },
  {
    ...
    fabricOptions: [{ name: "Organic Poplin", composition: "100% Organic Cotton", gsm: 115, weave: "Plain", width: "58\"", shrinkage: "3–4%", colorfastness: "Grade 4–5 (ISO 105)" }],
    certifications: [], moq: "500 pcs", leadTime: "10–12 weeks", sizeChart: standardSizeChart, exportCompliance,
  ...
  // ═══════════════════════════════════════════════════════════════════
  ...[
    { id: "rw-001", slug: "kaftan-cotton-voile", name: "Cotton Voile Kaftan", sub: "Kaftan", desc: "Lightweight cotton voile kaftan with hand-block printed borders. Oversized silhouette with side slits.", short: "Hand-block printed cotton voile kaftan.", colors: ["White/Indigo", "Ecru/Terracotta", "Natural/Olive"], fab: { comp: "100% Organic Cotton", gsm: 80, weave: "Plain" }, certs: [], chart: oneSizeChart },
    { id: "rw-002", slug: "wide-leg-linen-trousers", name: "Wide-Leg Linen Trousers", sub: "Trousers", desc: "Elegant wide-leg trousers in enzyme-washed linen. Elasticated back waist, front pleats, co-ord matching.", short: "Wide-leg linen trousers with elasticated waist.", colors: ["White", "Natural", "Black", "Navy", "Olive", "Sand"], fab: { comp: "100% Linen", gsm: 180, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-003", slug: "linen-blazer-unstructured", name: "Unstructured Linen Blazer", sub: "Blazer", desc: "Relaxed unstructured blazer in washed linen. No lining, patch pockets, and a soft shoulder. Resort and smart-casual.", short: "Unstructured washed linen blazer.", colors: ["Natural", "Navy", "Khaki", "Charcoal", "White"], fab: { comp: "100% Linen", gsm: 190, weave: "Plain" }, certs: [], chart: mensSizeChart },
    { id: "rw-004", slug: "printed-sarong-wrap", name: "Printed Cotton Sarong", sub: "Sarong", desc: "Large-format printed sarong in organic cotton voile. Multi-use — beach wrap, skirt, or shawl. Block print and digital options.", short: "Organic cotton sarong — block print and digital options.", colors: ["Indigo/White", "Tropical", "Botanical", "Geometric"], fab: { comp: "100% Organic Cotton", gsm: 70, weave: "Plain" }, certs: [], chart: oneSizeChart },
    { id: "rw-005", slug: "resort-jumpsuit", name: "Linen Resort Jumpsuit", sub: "Jumpsuit", desc: "Elegant wide-leg jumpsuit in washed linen. Button-front bodice, self-tie waist, and a relaxed Mediterranean aesthetic.", short: "Wide-leg linen jumpsuit with tie waist.", colors: ["White", "Navy", "Terracotta", "Olive", "Black"], fab: { comp: "100% Linen", gsm: 165, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-006", slug: "palazzo-pants-cotton", name: "Organic Cotton Palazzo Pants", sub: "Palazzo", desc: "Ultra-wide palazzo pants in organic cotton. Elasticated waist for comfort with a flowing, dramatic silhouette.", short: "Organic cotton palazzo pants with elastic waist.", colors: ["White", "Black", "Navy", "Terracotta", "Sage"], fab: { comp: "100% Organic Cotton", gsm: 120, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-007", slug: "beach-cover-up-crochet", name: "Crochet Trim Beach Cover-Up", sub: "Cover-Up", desc: "Lightweight cover-up with hand-crochet trim at neckline and hem. Organic cotton voile body with an oversized silhouette.", short: "Organic cotton cover-up with crochet trim.", colors: ["White", "Ecru", "Sand"], fab: { comp: "100% Organic Cotton", gsm: 75, weave: "Plain" }, certs: [], chart: oneSizeChart },
    { id: "rw-008", slug: "linen-shorts", name: "Relaxed Linen Bermuda Shorts", sub: "Shorts", desc: "Knee-length Bermuda shorts in washed linen. Elasticated waist with drawstring, side pockets, and a relaxed fit.", short: "Washed linen Bermuda shorts with drawstring.", colors: ["Natural", "White", "Navy", "Olive", "Sand", "Charcoal"], fab: { comp: "100% Linen", gsm: 170, weave: "Plain" }, certs: [], chart: mensSizeChart },
    { id: "rw-009", slug: "cotton-wrap-skirt", name: "Organic Cotton Wrap Skirt", sub: "Wrap Skirt", desc: "Versatile wrap skirt in organic cotton with adjustable tie. Midi length with a flowing silhouette.", short: "Organic cotton midi wrap skirt.", colors: ["Black", "Navy", "Terracotta", "Olive", "Floral Print"], fab: { comp: "100% Organic Cotton", gsm: 115, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-010", slug: "resort-maxi-skirt", name: "Tiered Resort Maxi Skirt", sub: "Maxi Skirt", desc: "Floor-length tiered maxi skirt in organic cotton voile. Elasticated waist with three tiers for maximum movement.", short: "Organic cotton voile tiered maxi skirt.", colors: ["White", "Terracotta", "Indigo", "Sage", "Printed"], fab: { comp: "100% Organic Cotton", gsm: 80, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-011", slug: "resort-cropped-top", name: "Linen Cropped Resort Top", sub: "Cropped Top", desc: "Cropped linen top with tie-back detail and puff sleeves. Pairs with high-waisted trousers and skirts.", short: "Cropped linen top with tie-back and puff sleeves.", colors: ["White", "Natural", "Terracotta", "Sage"], fab: { comp: "100% Linen", gsm: 155, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-012", slug: "drawstring-cotton-trousers", name: "Drawstring Cotton Trousers", sub: "Drawstring", desc: "Easy-wear drawstring trousers in organic cotton. Tapered leg, side pockets, and a relaxed waist.", short: "Organic cotton drawstring trousers — tapered leg.", colors: ["White", "Black", "Navy", "Khaki", "Sage", "Terracotta"], fab: { comp: "100% Organic Cotton", gsm: 140, weave: "Twill" }, certs: [], chart: standardSizeChart },
    { id: "rw-013", slug: "linen-tunic-dress", name: "Linen Tunic Dress", sub: "Tunic Dress", desc: "Relaxed linen tunic dress with side pockets and a rolled-cuff detail. Wear as a dress or over trousers.", short: "Linen tunic dress with pockets.", colors: ["Natural", "White", "Sky Blue", "Olive", "Sand"], fab: { comp: "100% Linen", gsm: 160, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-014", slug: "resort-halter-top", name: "Organic Cotton Halter Top", sub: "Halter", desc: "Minimal halter top in organic cotton with adjustable ties and a clean back. Perfect for resort layering.", short: "Organic cotton halter top with adjustable ties.", colors: ["White", "Black", "Terracotta", "Sage", "Coral"], fab: { comp: "100% Organic Cotton", gsm: 110, weave: "Plain" }, certs: [], chart: standardSizeChart },
    { id: "rw-015", slug: "linen-shirt-jacket", name: "Linen Shirt Jacket (Shacket)", sub: "Shacket", desc: "Oversized linen shirt jacket for layering. Patch pockets, button-through, and a relaxed shoulder. Resort and transitional.", short: "Linen shacket — oversized shirt jacket for layering.", colors: ["Natural", "Olive", "Navy", "Sand", "Charcoal"], fab: { comp: "100% Linen", gsm: 200, weave: "Twill" }, certs: [], chart: mensSizeChart },
  ].map((s) => ({
  ...
  ...[
    ...
    description: `Lightweight ${s.name.toLowerCase()} designed for wholesale summer collections. Organic cotton or linen construction with breathable comfort and effortless style. Available in seasonal colourways.`,
  ...
  ...[
    ...
    description: `Matching ${s.name.toLowerCase()} — top and bottom sold as a set. Premium construction with coordinated fabric and colourways. Designed for wholesale and private label.`,
  ...
  ...[
    ...
    certifications: [], moq: "200 pcs", leadTime: "8–10 weeks", sizeChart: oneSizeChart, exportCompliance,
  ...
  ...[
    ...
    description: `Premium ${s.name.toLowerCase()} for wholesale loungewear buyers. Soft, sustainable fabrics with attention to comfort and durability. Private label packaging available.`,
  ...
  ...[
    ...
    description: `Premium ${s.name.toLowerCase()} in organic cotton piqué. Rib-knit collar and cuffs, side vents, and embroidery-ready chest panel. Corporate and retail wholesale.`,
    shortDescription: `${s.name} in organic cotton piqué.`,
    ...
    certifications: [], moq: "500 pcs", leadTime: "5–6 weeks", sizeChart: mensSizeChart, exportCompliance,
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    certifications: [], moq: "100 pcs", leadTime: "60-90 days", sizeChart: standardSizeChart, exportCompliance,
  ...
  },
  {
    ...
    fabricOptions: [{ name: "Organic Cotton Poplin", composition: "100% Organic Cotton", gsm: 110, weave: "Plain", width: "58\"", shrinkage: "3–4%", colorfastness: "Grade 4–5 (ISO 105)" }],
    certifications: [], moq: "100 pcs", leadTime: "60-90 days", sizeChart: standardSizeChart, exportCompliance,
    features: ["Hand embroidery bodice", "A-line midi silhouette", "3/4 sleeves", "Organic cotton"], tags: ["embroidery", "dress", "cotton", "midi", "artisan"],
