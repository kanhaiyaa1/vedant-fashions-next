...
export const qualityControlContent: Record<string, QualityControlLocale> = {
  ...
  en: {
    ...
    process: {
      subtitle: "Process",
      title: "4-Stage Quality Assurance",
      stages: [
        {
          stage: "Incoming Fabric Inspection",
          checks: [
            "GSM weight verification (ISO 3801)",
            "Shrinkage testing — wash & dry (ISO 6330)",
            "Colorfastness to washing (ISO 105-C06, Grade 4+ required)",
            "Colorfastness to rubbing — wet & dry (ISO 105-X12)",
            "Visual defect scanning — 4-point system",
            "Fibre composition analysis via FTIR spectroscopy",
          ],
        },
        {
          stage: "Pre-Production Approval",
          checks: [
            "Counter sample vs. buyer-approved spec sheet",
            "Fit approval on live model across 3–5 sizes",
            "SPI count and seam strength verification",
            "Trim, button, and accessories match check",
            "Wash test on PP sample — 3 home washes",
            "Label placement, content, and EU regulation compliance",
          ],
        },
        {
          stage: "In-Line Inspection",
          checks: [
            "Real-time defect tracking per sewing operation",
            "AQL 2.5 random sampling during production",
            "Broken needle policy — every needle accounted for",
            "Thread tension and stitch consistency audit",
            "Measurement audit every 500 pieces (12 critical points)",
            "Pattern matching, print alignment, and grain check",
          ],
        },
        {
          stage: "Final Inspection (Pre-Shipment)",
          checks: [
            "AQL 2.5 inspection per ISO 2859-1 Level II",
            "100% measurement check on all critical points",
            "Metal detection / needle scanning — every piece",
            "Appearance, pressing, and folding to buyer standards",
            "Barcode scan verification and hangtag accuracy",
            "Carton drop test (ISTA 1A) and packing integrity check",
          ],
        },
      ],
    },
