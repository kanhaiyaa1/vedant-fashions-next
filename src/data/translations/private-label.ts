...
export const privateLabelContent: Record<string, PrivateLabelLocale> = {
  ...
  en: {
    hero: {
      ...
      description: "Full private-label manufacturing from concept to delivery. We produce under your brand with complete confidentiality, compliant labelling, and full traceability from our Mumbai production unit.",
    },
    advantages: {
      subtitle: "Why Vedant",
    ...
    included: {
      ...
      items: [
        ...
        "Full chain-of-custody documentation on your labels",
    ...
    pricing: {
      ...
      items: [
        ...
        "Fabric testing costs (lab reports)",
  ...
  ar: {
    hero: {
      ...
      description: "تصنيع كامل للعلامة التجارية الخاصة من الفكرة حتى التسليم. ننتج تحت علامتكم بسرية تامة، وعلامات ممتثلة، وتتبع كامل من منشأتنا في مومباي.",
    },
    advantages: {
    ...
    included: {
      ...
      items: [
        ...
        "وثائق كاملة لسلسلة الحيازة على بطاقاتكم",
    ...
    pricing: {
      ...
      items: [
        ...
        "تكاليف اختبار الأقمشة (تقارير المختبر)",
  ...
  ru: {
    hero: {
      ...
      description: "Полный производственный цикл под частной торговой маркой — от концепции до поставки. Производим под вашим брендом с полной конфиденциальностью, соответствующей маркировкой и полной прослеживаемостью с нашего производства в Мумбаи.",
    },
    advantages: {
    ...
    included: {
      ...
      items: [
        ...
        "Полная документация цепочки хранения на ваших этикетках",
    ...
    pricing: {
      ...
      items: [
        ...
        "Затраты на тестирование тканей (лабораторные отчёты)",
  ...
  pl: {
    hero: {
      ...
      description: "Pełna produkcja marki własnej od koncepcji do dostawy. Produkujemy pod Twoją marką z pełną poufnością, zgodnym etykietowaniem i pełną identyfikowalnością z naszego zakładu w Mumbaju.",
    },
    advantages: {
    ...
    included: {
      ...
      items: [
        ...
        "Pełna dokumentacja łańcucha własności na Twoich etykietach",
    ...
    pricing: {
      ...
      items: [
        ...
        "Koszty testowania tkanin (raporty laboratoryjne)",
  ...
  fr: {
    hero: {
      ...
      description: "Fabrication complète en marque privée de la conception à la livraison. Nous produisons sous votre marque avec une confidentialité totale, un étiquetage conforme et une traçabilité complète depuis notre unité de production à Mumbai.",
    },
    advantages: {
    ...
    included: {
      ...
      items: [
        ...
        "Documentation complète de chaîne de traçabilité sur vos étiquettes",
    ...
    pricing: {
      ...
      items: [
        ...
        "Coûts de tests de tissus (rapports de laboratoire)",
  ...
  it: {
    hero: {
      ...
      description: "Produzione completa a marchio privato dalla concezione alla consegna. Produciamo sotto il vostro brand con totale riservatezza, etichettatura conforme e piena tracciabilità dal nostro stabilimento di Mumbai.",
    },
    advantages: {
    ...
    included: {
      ...
      items: [
        ...
        "Documentazione completa della catena di custodia sulle vostre etichette",
    ...
    pricing: {
      ...
      items: [
        ...
        "Costi di test dei tessuti (rapporti di laboratorio)",
  ...
  nl: {
    hero: {
      ...
      description: "Volledige productie onder eigen merk van concept tot levering. We produceren onder uw merk met volledige vertrouwelijkheid, conforme etikettering en volledige traceerbaarheid vanuit onze productie-eenheid in Mumbai.",
    },
    advantages: {
    ...
    included: {
      ...
      items: [
        ...
        "Volledige documentatie van de bewaarderscyclus op uw labels",
    ...
    pricing: {
      ...
      items: [
        ...
        "Stoftestkosten (laboratoriumrapporten)",
