  ...
  en: {
      ...
      items: [
        {
          ...
          features: [
            "Fabric sourcing from vetted, quality-tested mills",
            ...
            "Full compliance documentation per shipment",
          ],
        },
        {
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "Certifications", fob: "Not currently held", cmt: "Upon request", odm: "Not currently held" },
  ...
  ar: {
      ...
      items: [
        {
          ...
          features: [
            "توريد أقمشة من مطاحن موثوقة ومختبَرة الجودة",
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "الشهادات", fob: "غير متوفرة حالياً", cmt: "عند الطلب", odm: "غير متوفرة حالياً" },
  ...
  ru: {
      ...
      items: [
        {
          ...
          features: [
            "Закупка тканей у проверенных фабрик с контролем качества",
            ...
            "Полная документация о соответствии с каждой партией",
          ],
        },
        {
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "Сертификаты", fob: "В настоящее время отсутствуют", cmt: "По запросу", odm: "В настоящее время отсутствуют" },
  ...
  pl: {
      ...
      items: [
        {
          ...
          features: [
            "Pozyskiwanie tkanin ze sprawdzonych, testowanych jakościowo zakładów",
            ...
            "Pełna dokumentacja zgodności z każdą przesyłką",
          ],
        },
        {
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "Certyfikaty", fob: "Obecnie brak", cmt: "Na żądanie", odm: "Obecnie brak" },
  ...
  fr: {
      ...
      items: [
        {
          ...
          features: [
            "Approvisionnement en tissus depuis des filatures vérifiées et testées",
            ...
            "Documentation de conformité complète par expédition",
          ],
        },
        {
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "Certifications", fob: "Non détenues actuellement", cmt: "Sur demande", odm: "Non détenues actuellement" },
  ...
  it: {
      ...
      items: [
        {
          ...
          features: [
            "Approvvigionamento tessuti da filature verificate e testate",
            ...
            "Documentazione di conformità completa per spedizione",
          ],
        },
        {
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "Certificazioni", fob: "Non attualmente detenute", cmt: "Su richiesta", odm: "Non attualmente detenute" },
  ...
  nl: {
      ...
      items: [
        {
          ...
          features: [
            "Stofinkoop bij geverifieerde, kwaliteitsgeteste fabrieken",
            ...
            "Volledige conformiteitsdocumentatie per zending",
          ],
        },
        {
    ...
    comparison: {
      ...
      rows: [
        ...
        { feature: "Certificaten", fob: "Momenteel niet aanwezig", cmt: "Op aanvraag", odm: "Momenteel niet aanwezig" },
