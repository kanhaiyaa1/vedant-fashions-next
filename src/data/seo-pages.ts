...
export const countryPages: CountryPage[] = [
  ...
  { slug: "poland", country: "Poland", region: "Central Europe", heroTitle: "Garment Manufacturer for Polish Brands", heroDescription: "Vedant Fashion exports ladies woven garments to Polish importers and wholesalers. FOB Mumbai to Gdańsk, 22–28 days. MOQ 100 pieces. FOB USD 5–8 per piece.", shippingTime: "22–28 days (sea to Gdańsk)", port: "Gdańsk / Gdynia", regulations: ["EU Textile Regulation 1007/2011", "REACH (EC) No 1907/2006", "Polish Consumer Protection Act", "Polish labelling requirements (fibre content in Polish mandatory)"], certifications: ["Basic certifications available — details on request"], incoterms: "FOB Gdańsk", dutyInfo: "GSP preferential tariff rates. EUR.1 Movement Certificate provided. EORI number required for import.", textileImportNotes: "Poland follows EU Textile Regulation 1007/2011. Care and fibre composition labels in Polish are required for retail sale. Vedant Fashion supplies Polish-language labels on request.", labellingLanguage: "Polish", tradeAgreement: "India-EU GSP (Generalised Scheme of Preferences)", marketInsight: "Poland is Central Europe's largest fashion market and one of the fastest growing in the EU. Competitive pricing with certified sustainability is a key differentiator — Polish importers increasingly seek GOTS-certified Indian suppliers.", metaTitle: "Ladies Woven Wear Manufacturer for Poland | Vedant Fashion India", metaDescription: "Ladies woven wear manufacturer for Polish buyers. Gdańsk port delivery, 22–28 days. MOQ 100 pcs. FOB USD 5–8. 60–90 day lead time. 60-day LC.",
    h1Title: "Ladies Woven Wear Manufacturer for Poland — Vedant Fashion",
    brandStatement: "Vedant Fashion is a ladies woven wear manufacturer based in Mumbai, India, exporting woven blouses, linen-blend shirts, cotton dresses, co-ord sets, and western wear to Polish importers and wholesale buyers. Our 5,000 sq ft facility handles in-house cutting, stitching, and finishing with 60 machines and 15 skilled workers. MOQ is 100 pieces per style per colour with 60–90 day bulk production lead times. Sea freight from Mumbai reaches Gdańsk Port in 22–28 days. FOB price: USD 5–8 per piece. Payment: 60-day LC in USD or EUR. Fabrics: viscose, rayon, georgette, linen blends, and crepe. Founder: Shravan Diwan, Director. Contact: +91 9930968116.",
    paymentTerms: ["LC at sight (irrevocable Letter of Credit)", "TT — 30% advance, 70% against shipping documents", "SWIFT wire transfer in EUR / PLN / USD"],
    faqs: [
      { q: "How long does sea freight take from India to Gdańsk?", a: "Sea freight from JNPT Mumbai to Gdańsk Port (Poland's main Baltic container terminal) takes 22–28 days depending on the routing — direct call or via North European transshipment hubs such as Hamburg or Rotterdam. We offer both FCL and LCL options with weekly sailings." },
      ...
      { q: "What is the MOQ for Polish buyers?", a: "Standard MOQ is 300 pieces per style per colour. For Polish wholesale buyers building an initial assortment, we recommend mixed-style orders of 2–4 styles at 150–300 pieces each to cover seasonal breadth while managing MOQ efficiently." },
      { q: "What payment terms are available for Polish buyers?", a: "We accept LC at sight (irrevocable), TT (30% advance before production, 70% against Bill of Lading), and SWIFT wire transfers in EUR, PLN, or USD. Most Polish buyers use TT or bank transfer; LC is recommended for first orders above €20,000." },
  ...
  { slug: "russia", country: "Russia", region: "CIS", heroTitle: "Garment Manufacturer for Russian Brands", heroDescription: "Vedant Fashion exports ladies woven garments to Russian importers and wholesalers. FOB Mumbai. MOQ 100 pieces per style. FOB USD 5–8 per piece. 60–90 day bulk lead time.", shippingTime: "25–32 days (sea to St. Petersburg / Novorossiysk)", port: "St. Petersburg / Novorossiysk", regulations: ["EAC (EurAsian Conformity) — TR CU 017/2011 (Safety of Light Industry Products)", "GOST R textile standards", "Russian Customs Code — garment HS classification", "Mandatory Russian-language care and composition labelling"], certifications: ["Basic certifications available — details on request"], incoterms: "FOB / CIF St. Petersburg or Novorossiysk / DDP", dutyInfo: "Import duties on woven garments vary by HS code (typically 10–15%). Certificate of Origin provided. EAC certification required for EAEU market entry.", textileImportNotes: "EAC (EurAsian Conformity) certification under TR CU 017/2011 is mandatory for textile products sold in Russia and EAEU countries. Russian-language care labels required. Vedant Fashion facilitates EAC certification via accredited Russian conformity assessment bodies.", labellingLanguage: "Russian", tradeAgreement: "India-Russia bilateral trade agreements; EAEU preferential arrangements", marketInsight: "Russia is a significant market for Indian garment exports. Premium positioning with certified sustainability appeals to the growing conscious consumer segment. St. Petersburg and Moscow retail markets are the primary destinations.", metaTitle: "Ladies Woven Wear Manufacturer for Russia | Vedant Fashion India", metaDescription: "Ladies woven wear manufacturer exporting to Russia. MOQ 100 pcs. FOB USD 5–8. 60–90 day lead time. Basic certifications available. 60-day LC.",
    h1Title: "Ladies Woven Wear Manufacturer for Russia — Vedant Fashion",
    brandStatement: "Vedant Fashion is a ladies woven wear manufacturer based in Mumbai, India, supplying Russian importers, fashion wholesalers, and retail chains with woven blouses, linen-blend shirts, cotton dresses, co-ord sets, and western wear. Our 5,000 sq ft facility handles in-house cutting, stitching, and finishing. MOQ is 100 pieces per style per colour with 60–90 day bulk production lead times and 2-week sample turnaround. Sea freight from Mumbai reaches St. Petersburg in 25–32 days. FOB price: USD 5–8 per piece. Payment: 60-day LC in USD or EUR. Fabrics: viscose, rayon, georgette, linen blends, and crepe. Founder: Shravan Diwan, Director. Contact: +91 9930968116.",
    paymentTerms: ["LC at sight (irrevocable Letter of Credit)", "TT — 30% advance, 70% against shipping documents", "SWIFT wire transfer in USD / EUR (RUB on request)"],
    faqs: [
      { q: "Which ports do you ship to in Russia?", a: "We ship to two main Russian ports: St. Petersburg (Baltic Sea, 25–32 days from Mumbai) and Novorossiysk (Black Sea, 25–30 days). St. Petersburg serves the Moscow and North-West retail corridor; Novorossiysk serves Southern Russia and Central Asia. We recommend port selection based on your distribution geography." },
  ...
  // ---- GCC / MENA / CIS ----
  {
    ...
    metaDescription: "Ladies woven wear manufacturer supplying UAE wholesale buyers. MOQ 100 pcs, 18–22 days to Jebel Ali. FOB USD 5–8. Basic certifications available. LC 60 days.",
    heroTitle: "Ladies Woven Wear Manufacturer for the UAE Market",
    heroDescription: "Vedant Fashion exports ladies woven garments to UAE importers and wholesalers. FOB Mumbai. 18–22 day sea transit to Jebel Ali. MOQ 100 pieces. FOB USD 5–8 per piece.",
    h1Title: "Ladies Woven Wear Manufacturer for UAE — Vedant Fashion",
    brandStatement: "Vedant Fashion is a ladies woven wear manufacturer based in Mumbai, India, supplying woven blouses, co-ord sets, cotton dresses, kurtis, and western wear to UAE wholesalers and fashion importers. Our 5,000 sq ft facility handles in-house cutting, stitching, and finishing. We accept orders from a minimum of 100 pieces per style per colour with a bulk lead time of 60–90 days and 2-week sample turnaround. Sea freight from Mumbai reaches Jebel Ali Port, Dubai in 18–22 days. FOB price: USD 5–8 per piece. Payment: 60-day LC. Founder: Shravan Diwan, Director. Contact: +91 9930968116.",
    shippingTime: "18–22 days (sea to Jebel Ali)",
    ...
    tradeAgreement: "India-UAE CEPA (Comprehensive Economic Partnership Agreement) — preferential duty for qualifying garments",
    ...
    paymentTerms: ["LC at sight (Letter of Credit via SWIFT)", "TT — 30% advance, 70% against Bill of Lading copy", "SWIFT wire transfer in USD / AED / EUR"],
    faqs: [
      { q: "What is the minimum order quantity for UAE buyers?", a: "Our standard MOQ is 100 pieces per style per colour. This applies to all ladies woven wear categories — blouses, dresses, co-ord sets, and kurtis. Contact Shravan Diwan directly for a custom quote: +91 9930968116." },
      { q: "How long does sea freight take from India to Jebel Ali?", a: "Sea freight from Mumbai / JNPT to Jebel Ali Port in Dubai takes 18–22 days on standard liner services. We consolidate shipments with trusted freight partners and provide a full Bill of Lading and tracking details on dispatch." },
  ...
  },
  {
    ...
    metaDescription: "GOTS-certified ladies woven wear manufacturer supplying Saudi Arabia. MOQ 300 pcs, 20–24 days to Dammam / Jeddah, SASO-compliant. LC/TT/SWIFT accepted.",
    ...
    h1Title: "Ladies Woven Wear Manufacturer for Saudi Arabia — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified manufacturer of ladies woven wear — including blouses, co-ord sets, linen shirts, and cotton dresses — exporting from India to Saudi Arabia. Our ISO 9001-certified factory spans 45,000 sq ft with dedicated cutting, sewing, and finishing lines for export orders. We ship to Dammam Port (Eastern Province) and Jeddah Islamic Port (Western Province) with sea transit times of 20–24 days from Mumbai. Minimum order is 300 pieces per style, with standard 45–55 day lead times. All garments carry SASO-compliant Arabic / English care labels. We accept LC at sight, TT, and SWIFT wire transfers. A dedicated Saudi account manager handles regulatory documentation including SASO conformity certificates and GSP Certificates of Origin.",
    shippingTime: "20–24 days (sea to Dammam / Jeddah)",
    port: "Dammam / Jeddah Islamic Port",
    regulations: ["SASO (Saudi Standards, Metrology and Quality Organization) textile regulations", "GSO 1956 — GCC Textile Products Standard", "Saudi Customs — HS code tariff classification for woven garments", "Arabic care label and fibre content disclosure requirement"],
    ...
    paymentTerms: ["LC at sight (irrevocable, confirmed by Indian bank)", "TT — 30% advance, 70% against shipping documents", "SWIFT wire transfer in USD / SAR / EUR"],
    faqs: [
      ...
      { q: "Which ports do you ship to in Saudi Arabia?", a: "We ship to Dammam Port (King Abdul Aziz Port) on the Arabian Gulf and Jeddah Islamic Port on the Red Sea. Sea transit from Mumbai / JNPT is 20–24 days. We work with established freight forwarders on both lanes for competitive rates." },
  ...
  },
  {
    ...
    metaDescription: "Ladies woven wear manufacturer supplying Qatar. GOTS certified, 20–23 days to Doha Port, GSO-compliant labelling, LC/TT/SWIFT payment. MOQ 300 pcs.",
    heroTitle: "Ladies Woven Wear Manufacturer for the Qatari Market",
    heroDescription: "Vedant Fashion exports certified ladies woven garments to Qatar importers and fashion retailers. Sea freight to Doha Port in 20–23 days from Mumbai. GSO-compliant labelling and full trade documentation.",
    h1Title: "Ladies Woven Wear Manufacturer for Qatar — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified Indian manufacturer of premium ladies woven wear — covering woven blouses, linen shirts, co-ord sets, resort wear, and cotton dresses — serving Qatar-based importers and wholesale buyers. Our 45,000 sq ft factory in India delivers end-to-end production with a minimum of 300 pieces per style and standard 45–55 day lead times. Sea freight from Mumbai reaches Doha Port, Qatar in 20–23 days. Garments are supplied with Arabic / English bilingual labels meeting GSO and Qatar GQSM standards. We accept LC at sight, TT, and SWIFT wire transfer. A dedicated export team prepares full Qatar customs documentation including Certificate of Origin and packing declarations. We are an ISO 9001:2015 certified facility with SEDEX social compliance audit.",
    shippingTime: "20–23 days (sea to Doha Port)",
    port: "Doha Port (Hamad Port)",
    regulations: ["GSO 1956 — GCC Textile Products Standard", "Qatar GQSM (General Organization for Standards & Metrology) requirements", "Arabic / English bilingual labelling mandate", "Qatar customs HS code classification for woven garments"],
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "SEDEX / SMETA"],
    ...
    textileImportNotes: "Qatar follows GSO 1956 for textile product labelling — fibre composition, care instructions, country of origin, and manufacturer details must appear in Arabic and English on woven or printed labels.",
    labellingLanguage: "Arabic / English",
    ...
    paymentTerms: ["LC at sight (irrevocable Letter of Credit)", "TT — 30% advance, 70% against Bill of Lading", "SWIFT wire transfer in USD / QAR / EUR"],
    faqs: [
      { q: "What is the lead time for garment orders to Qatar?", a: "Our standard production lead time is 45–55 days from order confirmation and fabric receipt. Sea freight from Mumbai to Hamad Port (Doha) adds 20–23 days. Total door-to-port timeline is typically 65–80 days, depending on order complexity and consolidation." },
      { q: "Which port do you ship to in Qatar?", a: "We ship to Hamad Port (also referred to as Doha Port), Qatar's primary container terminal located south of Doha. Sea transit from JNPT Mumbai is 20–23 days on weekly liner services. We work with both FCL and LCL freight options for Qatar shipments." },
  ...
  },
  {
    ...
    metaDescription: "Ladies woven wear manufacturer for Kuwait importers. GOTS certified, 19–22 days to Shuwaikh Port, GSO-compliant. MOQ 300 pcs. LC/TT/SWIFT accepted.",
    heroTitle: "Ladies Woven Wear Manufacturer for the Kuwaiti Market",
    heroDescription: "Vedant Fashion supplies premium ladies woven garments to Kuwait importers and fashion retailers. CIF delivery to Shuwaikh Port in 19–22 days. Full GSO compliance and Arabic labelling.",
    h1Title: "Ladies Woven Wear Manufacturer for Kuwait — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer in India, exporting premium blouses, linen shirts, co-ord sets, cotton dresses, and resort wear to Kuwait. Our ISO 9001:2015 certified factory manages the full production chain from fabric procurement through quality-checked export packing. We ship to Shuwaikh Port, Kuwait City in 19–22 days sea transit from Mumbai. Standard MOQ is 300 pieces per style with 45–55 day production lead times. Labels carry mandatory Arabic and English care and fibre content information per GSO 1956 and PAAET guidelines. Payment is accepted via LC at sight, TT, and SWIFT wire transfer in USD or KWD. A dedicated GCC export coordinator handles all customs paperwork, including Certificate of Origin and packing declarations.",
    shippingTime: "19–22 days (sea to Shuwaikh Port)",
    port: "Shuwaikh Port, Kuwait City",
    regulations: ["GSO 1956 — GCC Textile Products Standard", "Kuwait PAAET / PSNS textile product labelling requirements", "Arabic / English bilingual care label mandate", "Kuwait Customs — garment HS code classification"],
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "SEDEX / SMETA"],
    ...
    paymentTerms: ["LC at sight (irrevocable Letter of Credit)", "TT — 30% advance, 70% against shipping documents", "SWIFT wire transfer in USD / KWD / EUR"],
    faqs: [
      { q: "How do you ship garments to Kuwait from India?", a: "We ship via sea freight from JNPT Mumbai or Nhava Sheva to Shuwaikh Port, Kuwait City. Transit time is 19–22 days on weekly liner services. We offer both FCL (20ft / 40ft container) and LCL (groupage) options depending on order volume. Air freight is available for urgent replenishment orders." },
      ...
      { q: "What is your minimum order for Kuwait buyers?", a: "Standard MOQ is 300 pieces per style. For first-time Kuwait buyers, we recommend a mixed-style trial order combining 2–3 styles at 150 pieces each to test the market, with full production orders following within the same season." },
      { q: "Do you offer private label garments for Kuwaiti fashion brands?", a: "Yes. We provide full private label services — custom woven labels, hang-tags, polybag printing, and carton branding — for Kuwaiti fashion brands. ODM (design development) and OEM (buyer-supplied design) services are both available from our design studio." },
      ...
      { q: "Can you produce garments suited to Kuwait's climate?", a: "Absolutely. Kuwait's hot, arid climate calls for lightweight breathable fabrics. We specialise in 80–130 GSM organic cotton voile, linen, and cotton-linen blends — ideal for year-round summer-weight women's woven wear including blouses, wide-leg trousers, and casual dresses." },
    ],
  },
  {
    slug: "oman",
    ...
    metaDescription: "Ladies woven wear manufacturer supplying Oman. GOTS certified, 17–20 days to Muscat Port, DGSM-compliant labelling, MOQ 300 pcs. LC/TT/SWIFT.",
    heroTitle: "Ladies Woven Wear Manufacturer for the Omani Market",
    heroDescription: "Vedant Fashion exports certified ladies woven garments to Oman importers and wholesalers. Fastest sea transit among GCC ports — 17–20 days to Muscat from Mumbai. Full DGSM and GSO compliance.",
    h1Title: "Ladies Woven Wear Manufacturer for Oman — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer exporting from India to Oman. Our product range includes woven blouses, linen shirts, organic cotton dresses, co-ord sets, and resort wear, manufactured in our 45,000 sq ft ISO 9001:2015 certified facility. Oman benefits from the shortest sea freight transit among GCC destinations — just 17–20 days from Mumbai to Muscat Port. MOQ is 300 pieces per style with standard 45–55 day production lead times. We supply garments with Arabic / English bilingual labels meeting DGSM and GSO 1956 standards. Payment terms include LC at sight, TT, and SWIFT wire transfer. Our export documentation team provides full Oman customs paperwork including GSP Certificate of Origin, commercial invoice, and packing declaration.",
    shippingTime: "17–20 days (sea to Muscat Port)",
    port: "Port Sultan Qaboos / Sohar Port, Muscat",
    regulations: ["DGSM (Directorate General for Specifications & Metrology) Oman textile requirements", "GSO 1956 — GCC Textile Products Standard", "Arabic / English bilingual care label requirement", "Oman Customs garment HS code classification"],
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "SEDEX / SMETA"],
    ...
    paymentTerms: ["LC at sight (irrevocable Letter of Credit)", "TT — 30% advance, 70% against Bill of Lading", "SWIFT wire transfer in USD / OMR / EUR"],
    faqs: [
      { q: "How long does sea freight take from India to Oman?", a: "Oman is one of the closest GCC markets to India by sea. From JNPT Mumbai to Port Sultan Qaboos (Muscat), transit time is just 17–20 days — the shortest among all GCC ports. We offer weekly sailings with confirmed liner slots." },
      ...
      { q: "Do you offer resort and lightweight wear suitable for Oman's climate?", a: "Yes. Oman's climate calls for breathable, lightweight woven fabrics. Our resort wear, voile blouses, and linen dresses in 80–130 GSM are particularly well suited. We also offer moisture-wicking cotton-linen blends and anti-UV woven fabrics for the Omani summer market." },
  ...
  },
  {
    ...
    metaDescription: "GOTS-certified ladies woven wear manufacturer supplying Bahrain. 19–22 days to Khalifa Bin Salman Port. GSO-compliant. MOQ 300 pcs. LC/TT/SWIFT.",
    heroTitle: "Ladies Woven Wear Manufacturer for the Bahraini Market",
    heroDescription: "Vedant Fashion exports premium ladies woven garments to Bahrain importers and retailers. CIF delivery to Khalifa Bin Salman Port in 19–22 days. Full GSO / BSMD compliance with Arabic / English labelling.",
    h1Title: "Ladies Woven Wear Manufacturer for Bahrain — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer in India, supplying Bahraini importers with premium woven blouses, linen shirts, cotton dresses, co-ord sets, and resort wear. Our 45,000 sq ft ISO 9001:2015 factory manages complete in-house production from fabric sourcing to export packing. Sea freight from Mumbai reaches Khalifa Bin Salman Port, Bahrain in 19–22 days. Standard MOQ is 300 pieces per style with 45–55 day production lead times. Garments carry bilingual Arabic / English labels per GSO 1956 and Bahrain BSMD standards. We accept LC at sight, TT, and SWIFT wire transfer. The India-Bahrain bilateral trade relationship supports competitive export pricing, and our SEDEX social compliance audit documentation satisfies Bahraini buyer due diligence requirements.",
    shippingTime: "19–22 days (sea to Khalifa Bin Salman Port)",
    port: "Khalifa Bin Salman Port, Bahrain",
    regulations: ["GSO 1956 — GCC Textile Products Standard", "Bahrain BSMD (Bureau of Standards and Metrology) textile product requirements", "Arabic / English bilingual care label mandate", "Bahrain Customs garment HS classification"],
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "SEDEX / SMETA"],
    ...
    labellingLanguage: "Arabic / English",
    tradeAgreement: "India-GCC bilateral trade framework",
    marketInsight: "Bahrain's open economy and growing retail sector — anchored by The Avenues Bahrain and City Centre — create strong demand for quality Indian woven women's wear. Its position as a regional financial hub drives a professional consumer segment seeking premium, sustainable garments.",
    paymentTerms: ["LC at sight (irrevocable Letter of Credit)", "TT — 30% advance, 70% against shipping documents", "SWIFT wire transfer in USD / BHD / EUR"],
    faqs: [
      { q: "How do shipments reach Bahrain from India?", a: "We ship from JNPT Mumbai to Khalifa Bin Salman Port, Bahrain — the main commercial container terminal on Bahrain's north coast. Sea transit is 19–22 days on regular liner services. We offer both FCL and LCL options to suit order volumes." },
      { q: "Are your garments compliant with Bahrain BSMD / GSO standards?", a: "Yes. All garments are supplied with sewn-in bilingual Arabic / English woven labels per GSO 1956 and BSMD requirements — covering fibre composition, care symbols, country of origin, and manufacturer details. Compliance declarations and testing certificates are available on request." },
      { q: "What is the MOQ for Bahrain orders?", a: "Our standard MOQ is 300 pieces per style per colour. For Bahrain buyers starting a new sourcing relationship, we offer blended trial shipments of 2–4 styles at 150 pieces each to facilitate first-order risk management." },
      { q: "Do you provide private label services for Bahraini brands?", a: "Yes. We offer end-to-end private label solutions — custom woven brand labels, swing tags, poly-bag printing, and shipper carton branding. Our design studio can develop exclusive patterns and colourways for Bahraini fashion labels." },
  ...
  },
  {
    ...
    metaDescription: "Ladies woven wear manufacturer supplying Egypt. GOTS certified, 18–22 days to Alexandria Port, EOS-compliant. MOQ 300 pcs. LC/TT/SWIFT accepted.",
    ...
    h1Title: "Ladies Woven Wear Manufacturer for Egypt — Vedant Fashion",
    brandStatement: "Vedant Fashion exports ladies woven wear to wholesale buyers across Egypt — supplying blouses, dresses, co-ord sets, kurtis, modest wear adaptations, and occasion wear to fashion importers in Cairo, Alexandria, and Port Said. Our Mumbai facility produces across viscose, rayon, georgette, crepe, and linen blend fabrics. MOQ 100 pieces per style. FOB USD 5–8 per piece. Sea freight from Mumbai reaches Alexandria in 18–22 days and Port Said in 18–20 days.",
    shippingTime: "18–22 days (sea to Alexandria Port)",
    port: "Alexandria Port / Port Said",
    regulations: ["EOS (Egyptian Organisation for Standardisation & Quality) textile regulations", "Egyptian Textile Standardisation — ES 927 series", "Arabic / bilingual labelling requirement per Egyptian Consumer Protection Law", "Egypt Customs — garment HS code classification and import licensing"],
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "SEDEX / SMETA"],
    incoterms: "FOB / CIF Alexandria / DDP Egypt",
    dutyInfo: "Egypt imposes garment import duties ranging from 20–40% depending on HS code and fabric composition. An import licence (released under GOEIC) may be required. Certificate of Origin (preferential under COMESA or bilateral agreements where applicable) is provided.",
    ...
    paymentTerms: ["LC at sight (irrevocable, confirmed — preferred for first orders)", "TT — 30% advance, 70% against shipping documents", "SWIFT wire transfer in USD / EGP / EUR"],
    faqs: [
      { q: "What is the MOQ and FOB pricing for ladies garments exported to Egypt?", a: "Vedant Fashion's standard MOQ for Egyptian buyers is 100 pieces per style per colour — accessible for mid-size Egyptian importers and boutique wholesalers. FOB price is USD 5–8 per piece depending on fabric and construction. Formal quotation within 24 hours. Mixed style orders with 100 pieces minimum per style are supported." },
      { q: "How long does sea freight take from India to Egypt?", a: "Sea freight from JNPT Mumbai to Alexandria Port takes 18–22 days on direct and transship liner services. To Port Said (near the Suez Canal entry) the transit is 18–20 days — Port Said is the faster option for buyers who need faster access to onward distribution. We offer weekly sailings with both FCL and LCL options." },
  ...
  },
  {
    ...
    dutyInfo: "Import duty on ladies garments typically 40–45% under MFN rates. AGOA and SADC preferential rates not applicable for India-origin goods. Actual duties confirmed with South African customs broker.",
    ...
    tradeAgreement: "No bilateral preferential trade agreement — standard MFN rates apply",
    ...
    metaDescription: "GOTS-certified ladies woven wear manufacturer exporting to South Africa. Blouses, dresses, co-ords, kurtis. FOB USD 5–8. Sea freight to Durban 22–28 days. MOQ 100 pcs.",
    h1Title: "Ladies Woven Wear Manufacturer for South Africa — Vedant Fashion",
    brandStatement: "Vedant Fashion exports ladies woven wear to wholesale buyers across South Africa — supplying blouses, dresses, co-ord sets, kurtis, and occasion wear to fashion importers in Johannesburg, Cape Town, Durban, and Pretoria. Our Mumbai facility produces 10,000+ garments monthly across viscose, rayon, georgette, crepe, and linen blend fabrics. MOQ 100 pieces per style. FOB USD 5–8 per piece. Sea freight from Mumbai reaches Durban in 22–28 days.",
    paymentTerms: [
      "LC at sight (irrevocable Letter of Credit via SWIFT)",
      "TT — 30% advance, 70% against Bill of Lading copy",
      "Full advance TT — qualifies for 2% discount on FOB value",
    ],
    faqs: [
      { q: "What is the MOQ for ladies garments exported to South Africa?", a: "Vedant Fashion's standard MOQ for South Africa buyers is 100 pieces per style per colour — lower than most Indian manufacturers. This makes us accessible for mid-size South African fashion importers and boutique wholesalers. Mixed style orders are welcome with 100 pieces minimum per style." },
      { q: "How long does sea freight take from India to South Africa?", a: "Sea freight from JNPT Mumbai to Durban takes 22–28 days and to Cape Town 24–30 days, depending on the liner service and routing via the Cape of Good Hope or Suez Canal. We work with freight forwarders offering weekly liner services on the India–South Africa trade lane. Air freight to Johannesburg (JNB) takes 3–5 days for urgent orders." },
      { q: "What import duties apply on Indian garments entering South Africa?", a: "South Africa applies MFN (Most Favoured Nation) import duties on ladies garments from India — typically 40–45% on the CIF value. There is no bilateral free trade agreement between India and South Africa that reduces these rates. We recommend buyers consult a South African customs broker to confirm duties for their specific HS codes. We provide Certificate of Origin and all required documentation." },
  ...
  },
  {
    ...
    shippingTime: "18–24 days (sea to Istanbul / Mersin)",
    port: "Istanbul (Ambarlı) / Mersin",
    regulations: [
      "Turkish Standards Institution (TSE) textile standards",
      "Turkish Textile Labelling Regulation — TS EN ISO 3758 care symbols",
      "CE marking requirements where applicable",
      "REACH compliance for EU-bound re-exports",
      "Turkish customs tariff — GTİP codes for textile products",
    ],
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "BSCI", "ISO 9001:2015"],
    ...
    tradeAgreement: "No bilateral preferential trade agreement between India and Turkey — standard MFN rates apply",
    ...
    metaDescription: "GOTS-certified ladies woven wear manufacturer exporting to Turkey. Blouses, dresses, co-ords, occasion wear. FOB USD 5–8. Sea freight to Istanbul 18–24 days. MOQ 100 pcs.",
    h1Title: "Ladies Woven Wear Manufacturer for Turkey — Vedant Fashion",
    brandStatement: "Vedant Fashion exports ladies woven wear to wholesale buyers and fashion importers in Turkey — supplying blouses, dresses, co-ord sets, embroidery, and sequin occasion wear to buyers in Istanbul, Ankara, Izmir, and Bursa. Our Mumbai facility produces across viscose, rayon, georgette, crepe, and linen blend fabrics. MOQ 100 pieces per style. FOB USD 5–8. Sea freight from Mumbai reaches Istanbul in 18–24 days.",
    paymentTerms: [
      "LC at sight (irrevocable Letter of Credit via SWIFT)",
      "TT — 30% advance, 70% against Bill of Lading copy",
      "Full advance TT — qualifies for 2% discount on FOB value",
    ...
    faqs: [
      ...
      { q: "How long does sea freight take from India to Turkey?", a: "Sea freight from JNPT Mumbai to Istanbul (Ambarlı port) takes 18–24 days via the Suez Canal, depending on the liner service. To Mersin (southern Turkey) the transit is similar at 18–22 days. We work with freight forwarders on regular India–Turkey liner services. Air freight to Istanbul (IST) takes 2–3 days for urgent replenishment." },
      { q: "What import documentation is required for garments entering Turkey?", a: "Garments entering Turkey require: Commercial Invoice, Packing List, Bill of Lading, Certificate of Origin, and textile composition test report. Turkish customs uses GTİP (Turkish HS) codes aligned with international HS 2022. REACH compliance documentation may be required for buyers who re-export to EU markets. We provide a full documentation package with every shipment." },
      { q: "Which Indian garment styles sell well in the Turkish market?", a: "Turkish wholesale buyers typically seek ladies western wear with design differentiation from local Turkish production — printed blouses, embroidered tops, sequin occasion wear, and co-ord sets in rayon and viscose. The Laleli district in Istanbul serves wholesale buyers from Russia, Central Asia, and Eastern Europe, creating demand for fashion-forward ladies garments at competitive price points." },
