...
export const countryPages: CountryPage[] = [
  ...
  { slug: "poland", country: "Poland", region: "Central Europe", heroTitle: "Garment Manufacturer for Polish Brands", heroDescription: "Cost-effective garment manufacturing for the Polish market with full EU certification and Gdańsk port delivery.", shippingTime: "22–28 days (sea to Gdańsk)", port: "Gdańsk / Gdynia", regulations: ["EU Textile Regulation 1007/2011", "REACH (EC) No 1907/2006", "Polish Consumer Protection Act", "Polish labelling requirements (fibre content in Polish mandatory)"], certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "GRS 4.0", "BSCI"], incoterms: "FOB / CIF Gdańsk / DDP", dutyInfo: "GSP preferential tariff rates. EUR.1 Movement Certificate provided. EORI number required for import.", textileImportNotes: "Poland follows EU Textile Regulation 1007/2011. Care and fibre composition labels in Polish are required for retail sale. Vedant Fashion supplies Polish-language labels on request.", labellingLanguage: "Polish", tradeAgreement: "India-EU GSP (Generalised Scheme of Preferences)", marketInsight: "Poland is Central Europe's largest fashion market and one of the fastest growing in the EU. Competitive pricing with certified sustainability is a key differentiator — Polish importers increasingly seek GOTS-certified Indian suppliers.", metaTitle: "Ladies Woven Wear Manufacturer for Poland | Vedant Fashion India", metaDescription: "GOTS-certified ladies woven wear manufacturer for Polish brands. Gdańsk port delivery, 22–28 days. EU GSP preferential rates. MOQ 300 pcs. LC/TT/SWIFT.",
    h1Title: "Ladies Woven Wear Manufacturer for Poland — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer in India, exporting premium blouses, linen shirts, cotton dresses, co-ord sets, and resort wear to Polish importers and wholesale buyers. Our 45,000 sq ft ISO 9001:2015 factory manages complete end-to-end production with a minimum order of 300 pieces per style and 45–55 day lead times. Sea freight from Mumbai reaches Gdańsk Port in 22–28 days. As an EU GSP-eligible Indian exporter, we provide EUR.1 Movement Certificates for preferential duty access. Garments carry Polish-language care and composition labels meeting EU Textile Regulation 1007/2011. We accept LC at sight, TT, and SWIFT wire transfer in EUR or PLN. Poland's growing e-commerce and wholesale fashion sector makes it a strategic Central European destination for Indian woven wear.",
  ...
  { slug: "russia", country: "Russia", region: "CIS", heroTitle: "Garment Manufacturer for Russian Brands", heroDescription: "Premium garment manufacturing for the Russian market. St. Petersburg and Novorossiysk delivery, competitive pricing, and large-volume production capacity.", shippingTime: "25–32 days (sea to St. Petersburg / Novorossiysk)", port: "St. Petersburg / Novorossiysk", regulations: ["EAC (EurAsian Conformity) — TR CU 017/2011 (Safety of Light Industry Products)", "GOST R textile standards", "Russian Customs Code — garment HS classification", "Mandatory Russian-language care and composition labelling"], certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "EAC / GOST R Certificate (facilitated)"], incoterms: "FOB / CIF St. Petersburg or Novorossiysk / DDP", dutyInfo: "Import duties on woven garments vary by HS code (typically 10–15%). Certificate of Origin provided. EAC certification required for EAEU market entry.", textileImportNotes: "EAC (EurAsian Conformity) certification under TR CU 017/2011 is mandatory for textile products sold in Russia and EAEU countries. Russian-language care labels required. Vedant Fashion facilitates EAC certification via accredited Russian conformity assessment bodies.", labellingLanguage: "Russian", tradeAgreement: "India-Russia bilateral trade agreements; EAEU preferential arrangements", marketInsight: "Russia is a significant market for Indian garment exports. Premium positioning with certified sustainability appeals to the growing conscious consumer segment. St. Petersburg and Moscow retail markets are the primary destinations.", metaTitle: "Ladies Woven Wear Manufacturer for Russia | Vedant Fashion India", metaDescription: "GOTS-certified ladies woven wear manufacturer exporting to Russia. EAC/GOST compliant. St. Petersburg & Novorossiysk delivery. MOQ 300 pcs. LC/TT/SWIFT.",
    h1Title: "Ladies Woven Wear Manufacturer for Russia — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer in India, supplying Russian importers, fashion wholesalers, and retail chains with premium blouses, linen shirts, cotton dresses, co-ord sets, and resort wear. Our 45,000 sq ft ISO 9001:2015 certified factory handles end-to-end production from fabric procurement to export packing. Sea freight from Mumbai reaches St. Petersburg in 25–32 days; Novorossiysk (Black Sea) is also available as an alternate routing. MOQ is 300 pieces per style with 45–55 day production lead times. All garments comply with EAC (TR CU 017/2011) and GOST R textile standards, with mandatory Russian-language care labels. We accept LC at sight, TT, and SWIFT wire transfer in USD or EUR. Our team facilitates EAC conformity certification through accredited Russian assessment bodies.",
    ...
    faqs: [
      ...
      { q: "What is the MOQ for Russia buyers?", a: "Standard MOQ is 300 pieces per style per colour. Russia's large wholesale market supports higher volumes, and we offer preferential pricing at 500+ and 1,000+ pieces per style. Mixed-style orders can be arranged in consolidated 20ft containers." },
  ...
  // ---- GCC / MENA / CIS ----
  {
    ...
    metaDescription: "GOTS-certified ladies woven wear manufacturer supplying UAE wholesale buyers. MOQ 300 pcs, 18–22 days to Jebel Ali, ESMA-compliant labelling, LC/TT/SWIFT payment.",
    heroTitle: "Ladies Woven Wear Manufacturer for the UAE Market",
    heroDescription: "Vedant Fashion exports premium ladies woven garments to UAE importers and wholesalers. GOTS, OEKO-TEX, and ISO 9001 certified factory in India. FOB / CIF Jebel Ali with 18–22 day sea transit from Mumbai.",
    h1Title: "Ladies Woven Wear Manufacturer for UAE — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer based in India, supplying premium woven blouses, co-ord sets, cotton dresses, linen shirts, and resort wear to UAE wholesalers and fashion importers. Our 45,000 sq ft factory handles end-to-end production — from fabric sourcing and pattern making to finishing and export packing. We accept orders from a minimum of 300 pieces per style with a standard lead time of 45–55 days. Sea freight from Mumbai reaches Jebel Ali Port, Dubai in 18–22 days, making us one of the most time-efficient India-origin suppliers for GCC buyers. We accept payment via LC at sight, TT, and SWIFT transfer. Our ISO 9001 quality management and ESMA-compliant labelling ensure smooth UAE customs clearance.",
    ...
    certifications: ["GOTS 6.0", "OEKO-TEX Standard 100", "ISO 9001:2015", "SEDEX / SMETA 4-Pillar Audit"],
    incoterms: "FOB / CIF Jebel Ali / DDP Dubai",
    ...
    faqs: [
      { q: "What is the minimum order quantity for UAE buyers?", a: "Our standard MOQ is 300 pieces per style per colour. For UAE trial orders or new product introductions, we offer a reduced MOQ of 150 pieces at a slight premium on unit cost. Contact our export team for a custom quote." },
  ...
  },
  {
    ...
    heroDescription: "Vedant Fashion exports certified ladies woven garments to Egyptian importers, wholesalers, and retail groups. Sea freight to Alexandria Port in 18–22 days from Mumbai. Full EOS compliance and Arabic labelling.",
    h1Title: "Ladies Woven Wear Manufacturer for Egypt — Vedant Fashion",
    brandStatement: "Vedant Fashion is a GOTS 6.0 and OEKO-TEX Standard 100 certified ladies woven wear manufacturer in India, supplying Egypt-based importers with premium blouses, linen shirts, cotton dresses, co-ord sets, and resort wear. Our 45,000 sq ft ISO 9001:2015 certified factory in India handles the full production cycle from yarn-sourced fabrics to finished, packed export goods. Sea freight from Mumbai to Alexandria Port takes 18–22 days, making Egypt one of our most accessible MENA markets. MOQ is 300 pieces per style with 45–55 day lead times. All garments comply with EOS (Egyptian Organisation for Standardisation & Quality) textile standards, with bilingual Arabic / English care and composition labels. We accept LC at sight, TT, and SWIFT wire transfer. Egypt's proximity to European and Gulf re-export markets makes Alexandria a strategic distribution point for our MENA buyers.",
    ...
    marketInsight: "Egypt is the largest garment market in Africa and the Arab world, with a population of over 105 million and a rapidly growing urban middle class. Demand for quality imported women's woven wear is strong in Cairo, Alexandria, and the Delta retail corridor — creating significant wholesale opportunity for certified Indian manufacturers.",
    ...
    faqs: [
      { q: "How long does sea freight take from India to Egypt?", a: "From JNPT Mumbai to Alexandria Port, sea transit is 18–22 days on direct and transship liner services. We also ship to Port Said (near the Suez Canal entry), which is a common transshipment and direct-call port. We offer weekly sailings with FCL and LCL options." },
      { q: "Are your garments compliant with Egyptian EOS standards?", a: "Yes. We supply garments with Arabic-language care and composition labels per EOS ES 927 series requirements. Egyptian Customs and GOEIC may inspect textile imports; we provide a full pre-shipment inspection report from a third-party lab (SGS / Intertek) on request to facilitate clearance." },
      { q: "What is the import duty on garments in Egypt?", a: "Egyptian import duties on woven garments typically range from 20–40% depending on the specific HS code and fabric content. An import licence issued through GOEIC may also be required. We recommend working with an experienced Egyptian customs broker; we can provide references from our existing Cairo-based buyers." },
      { q: "What is the MOQ for Egypt buyers?", a: "Standard MOQ is 300 pieces per style per colour. Egypt's large wholesale market supports higher volume orders, and we offer better unit pricing at 1,000 pieces+. We also accommodate seasonal assortment orders combining multiple styles." },
      { q: "What payment terms do you offer Egyptian buyers?", a: "We strongly recommend LC at sight (irrevocable, confirmed by a top-tier Egyptian bank) for first-time orders due to Egypt's foreign-currency regulations. For established buyers, we accept TT (30% advance, 70% before shipment) and SWIFT wire transfers in USD, EUR, or EGP." },
      { q: "Can Egypt be used as a re-export hub for the wider MENA region?", a: "Yes. Alexandria and Port Said are well-positioned for re-export to North Africa (Libya, Tunisia, Morocco) and the Levant (Jordan, Lebanon). Egypt's COMESA membership and bilateral trade agreements with Arab League countries make it a strategic distribution point. We can assist with documentation for re-export use cases." },
    ],
  },
];
